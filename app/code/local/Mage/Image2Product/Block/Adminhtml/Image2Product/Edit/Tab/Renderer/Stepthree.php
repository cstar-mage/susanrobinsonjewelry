...
class Mage_Image2Product_Block_Adminhtml_Image2Product_Edit_Tab_Renderer_Stepthree extends Varien_Data_Form_Element_Text
{
	...
	public function getHtml()
    {
    	...
    	$html .= '<button style="" onclick="setLocation(\'/Image2Product/adminhtml_Image2Product/generatecsv/\')" class="scalable save" type="button" title="Generate CSV" id="id_1b914854b2924f875489e730998bcd92"><span><span><span>Generate CSV</span></span></span></button>';
		return $html;       
    }
}