...
class Mage_Catalog_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        //echo "<pre>";print_r($this->_getConfig()->getAttributeUsedForSortByArray()); exit;
    ...
    public function getCurrentDirection()
    {
        ...
        if (!$dir || !in_array($dir, $directions)) {
            ...
            if($this->getCurrentOrder() == 'price' || $this->getCurrentOrder() == 'position') {
            	$dir = 'asc';
            }
