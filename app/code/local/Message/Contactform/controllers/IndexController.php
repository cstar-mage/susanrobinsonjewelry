 	...
 	public function postAction()
    {
        ...
        if ($post = $this->getRequest()->getPost()) {
	        	...
	        	try {
					...
					Mage::getSingleton('core/session')->addSuccess(Mage::helper('contactform')->__($success_message));
					$this->_redirectReferer();
					return;
                	...
                	$failure_message = Mage::getStoreConfig('contacts/contactform/error_message');
                   	Mage::getSingleton('core/session')->addError(Mage::helper('contactform')->__($failure_message));
       				 $this->_redirectReferer();
       				 return;
                } 
	    ...
	    Mage::getSingleton('core/session')->addError(Mage::helper('contactform')->__('Unable to find data.'));
	    $this->_redirectReferer();
    }    
}
