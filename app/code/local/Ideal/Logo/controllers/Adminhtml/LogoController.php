		...
		try {
			...
			if(isset($_FILES['design_header_logo_src']['name']) && $_FILES['design_header_logo_src']['name'] != '') {
				try {
					...
					$path2 = Mage::getDesign()->getSkinBaseDir(array('_area'=>'frontend','_package'=>'default','_theme'=>'default'));
					$path3 = Mage::getDesign()->getSkinBaseDir(array('_area'=>'frontend','_package'=>'base','_theme'=>'default'));
					...
					copy($path."/images/". $_FILES['design_header_logo_src']['name'] , $path2."/images/". $_FILES['design_header_logo_src']['name'] );
					copy($path."/images/". $_FILES['design_header_logo_src']['name'] , $path3."/images/". $_FILES['design_header_logo_src']['name'] );
			...
			if(isset($_FILES['design_header_logo_src_small']['name']) && $_FILES['design_header_logo_src_small']['name'] != '') {
				try {
					...
					copy($path."/images/".$_FILES['design_header_logo_src_small']['name'] , $path2."/images/".$_FILES['design_header_logo_src_small']['name'] );
					copy($path."/images/".$_FILES['design_header_logo_src_small']['name'] , $path3."/images/".$_FILES['design_header_logo_src_small']['name'] );
