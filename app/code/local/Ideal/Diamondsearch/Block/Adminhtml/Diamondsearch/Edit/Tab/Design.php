...
class Ideal_Diamondsearch_Block_Adminhtml_Diamondsearch_Edit_Tab_Design extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
  	...
  	$fieldset = $form->addFieldset('diamondsearch_form_general', array('legend'=>Mage::helper('diamondsearch')->__('General')));
        ...
        $fieldset->addField('diamondsview_shape_title', 'text', array(
			'label'     => Mage::helper('diamondsearch')->__('Shape title'),
			'name'      => 'diamondsview_shape_title',
			'value'  	=> Mage::getStoreConfig("diamondsearch/general_settings/diamondsview_shape_title")
		));
        ...
        $fieldset->addField('diamonds_owner_mask', 'textarea', array(
			'label'     => Mage::helper('diamondsearch')->__('Owner value mask'),
			'name'      => 'diamonds_owner_mask',
			'style'		=> 'height:100px',
			'value'  	=> Mage::getStoreConfig("diamondsearch/general_settings/diamonds_owner_mask"),
			'note' => 'Example: OWNER1=A,OWNER2=B,OWNER3=C...'
		));
		...
		$fieldset->addField('diamond_shape_title', 'text', array(
				'label'     => Mage::helper('diamondsearch')->__('Diamond Shape Title'),
				'name'      => 'diamond_shape_title',
				'value'  	=> Mage::getStoreConfig("diamondsearch/general_settings/diamond_shape_title"),
				'note' => 'For details page. Use these variable: {{shape}}'
		));
		
		$fieldset->addField('diamond_found_title', 'text', array(
				'label'     => Mage::helper('diamondsearch')->__('Diamond Found Title'),
				'name'      => 'diamond_found_title',
				'required' => true,
				'value'  	=> Mage::getStoreConfig("diamondsearch/general_settings/diamond_found_title"),
    ...
    $fieldset->addField('viewpage_button_bgcolor', 'colorpicker', array(
		...
		$fieldset = $form->addFieldset('diamondsearch_font_design', array('legend'=>Mage::helper('diamondsearch')->__('Fonts')));
		
		$fieldset->addType('select_fonts', Mage::getConfig()->getBlockClassName('Ideal_Diamondsearch_Block_Adminhtml_Diamondsearch_Edit_Renderer_Font'));
		
		//$fieldset->addField('diamond_default_fonts', 'select', array(
		//		'label'     => Mage::helper('diamondsearch')->__('Fonts'),
		//		'name'      => 'diamond_default_fonts',
		//		'value'=> (Mage::getStoreConfig("diamondsearch/general_settings/diamond_default_fonts")) ? Mage::getStoreConfig("diamondsearch/general_settings/diamond_default_fonts") : "Arial",
		//		'values' => array(
		//											'Automatic' => 'Automatic',
		//											'Arial' => 'Arial',
		//											'Courier'=>'Courier',
		...
		$fieldset->addField('diamond_fonts_enable_googlefont', 'select', array(
      		'label'     => Mage::helper('diamondsearch')->__('Enable Google Font:'),
      		'name'      => 'diamond_fonts_enable_googlefont',
					'value'     => (Mage::getStoreConfig("diamondsearch/general_settings/diamond_fonts_enable_googlefont")) ? Mage::getStoreConfig("diamondsearch/general_settings/diamond_fonts_enable_googlefont") : "",
      		'options'   => array(
      				0 => Mage::helper('diamondsearch')->__('No'),
      				1 => Mage::helper('diamondsearch')->__('Yes'),
      		),
      ));
      
      $fieldset->addField('diamond_fonts_all', 'select_fonts', array(
      		'name' => 'diamond_fonts_all',
      		'label' => Mage::helper('diamondsearch')->__('Select Font:'),
					'value'=> (Mage::getStoreConfig("diamondsearch/general_settings/diamond_fonts_all")) ? Mage::getStoreConfig("diamondsearch/general_settings/diamond_fonts_all") : "Economica",
      		'values' => Mage::getModel('diamondsearch/Font')->toOptionArray(),
      		'note'  => Mage::helper('diamondsearch')->__('Enable google font to use this option'),
      ));
