...
class Ideal_Diamondsearch_IndexController extends Mage_Core_Controller_Front_Action
{
    public function viewAction()
    {
		...
		if ($block){//check if block actually exists
			if(Mage::getStoreConfig("diamondsearch/general_settings/use_rapnet_instant_api_data")==1){
				$block->setTemplate("diamondsearch/diamondview-rapnet.phtml"); 
			}
			elseif(Mage::getStoreConfig("diamondsearch/general_settings/spacial_diamond_avilability")==1){
