  ...
  protected function _beforeToHtml()
  {
	//  echo $this->getRequest()->getParam('id');
	 ...
	 switch ($tab_block) {
		...
		break;
		case "evolved_privacypolicy":
			 $this->addTab('evolved_privacypolicy', array(
					'label'     => Mage::helper('evolved')->__('Privacy Policy'),
					'title'     => Mage::helper('evolved')->__('Privacy Policy'),
					'content'   => $this->getLayout()->createBlock('evolved/adminhtml_evolved_edit_tab_privacypolicy')->toHtml(),
			  ));
		break;
		...
		break;
		case "evolved_captcha":
			$this->addTab('evolved_captcha', array(
			'label'     => Mage::helper('evolved')->__('Captcha'),
			'title'     => Mage::helper('evolved')->__('Captcha'),
			'content'   => $this->getLayout()->createBlock('evolved/adminhtml_evolved_edit_tab_captcha')->toHtml(),
			));
		break;
	}
