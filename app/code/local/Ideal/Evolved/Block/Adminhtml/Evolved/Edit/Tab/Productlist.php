...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Tab_Productlist extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
	  ...
	  $fieldsetgeneral->addField('productlist_product_infinitescroll', 'select', array(
      		'label'     => Mage::helper('evolved')->__('Enable Infinite Scroll'),
      		'name'      => 'evolved_form_productlist_general[productlist_product_infinitescroll]',
      		'values'    => array(
      				array('value'=>'','label'=>'Please Select'),
