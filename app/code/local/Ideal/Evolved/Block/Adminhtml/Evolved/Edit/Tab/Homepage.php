...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Tab_Homepage extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
      ...
      $fieldset_page_element_three->addField('homepage_element_three_style_marginbottom', 'text', array(
      		'label'     => Mage::helper('evolved')->__('Margin Bottom In Pixels:'),
      		'name'      => 'evolved_homepage_element_three[homepage_element_three_style_marginbottom]',
      ));
