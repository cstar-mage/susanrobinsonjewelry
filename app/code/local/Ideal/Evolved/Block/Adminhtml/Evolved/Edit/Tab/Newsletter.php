...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Tab_Newsletter extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
     ...
     $fieldsetnewsletter->addField('newsletter_popup_enable', 'select', array(
      ...
      $fieldsetnewsletter->addField('newsletter_popup_width', 'text', array(
     		'label'     => Mage::helper('evolved')->__('popup width:'),
     		'name'      => 'evolved_form_newsletter[config][newsletter_popup_width]',
     ));
     
     
     $fieldsetnewsletter->addField('newsletter_popup_hight', 'text', array(
     		'label'     => Mage::helper('evolved')->__('popup Hight:'),
     		'name'      => 'evolved_form_newsletter[config][newsletter_popup_hight]',
     ));
     
     
     $fieldsetnewsletter->addField('newsletter_popup_emailsignup', 'select', array(
      		'label'     => Mage::helper('evolved')->__('Email Signup ?:'),
      		'name'      => 'evolved_form_newsletter[config][newsletter_popup_emailsignup]',
      		'options'   => array(
      				'on' => Mage::helper('evolved')->__('On'),
      				'off' => Mage::helper('evolved')->__('Off'),
      		),
