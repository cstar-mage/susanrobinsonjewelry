...
class Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Tab_Header extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
      ...
      $fieldsetgeneral->addField('toplinks_underline_color', 'text', array(
			'label'     => Mage::helper('evolved')->__('Underline below toplinks:'),
      		'name'      => 'evolved_form_header_general[toplinks_underline_color]',
      ));
	...
	*/
     ...
     $fieldsetDropdownstoplink->addField('top_links_option', 'multiselect', array(
      		...
      		'values' => array(
      								...
      								array('value'=>'about/' , 'label' =>'About'),
      								array('value'=>'faq/' , 'label' =>'FAQ')
      						),
      ));
      
      $fieldsetDropdownstoplink->addField('social_links_option', 'multiselect', array(
      		'label'     => Mage::helper('evolved')->__('Social Links options'),
      		'name'      => 'evolved_form_header_dropdown_toplink[social_links_option]',
      		'values' => array(
				      				array('value'=>'' , 'label' => 'Please Select'),
      							    ...
      							    array('value'=>'polyvore' , 'label' => 'Polyvore'), */
      							    array('value'=>'yelp' , 'label' => 'Yelp'),
      							    array('value'=>'youtube' , 'label' => 'Youtube'),
      							    array('value'=>'plus_google' , 'label' => 'Google Plus'),
      							    array('value'=>'linkedin' , 'label' => 'Linked In'),
      							    array('value'=>'tumbler' , 'label' => 'Tumbler')
      						),
      )); 
      ...
      */
      ...
      $fieldsetnavigation->addField('navigation_menu_vertical_alignment', 'select', array(
      		'label'     => Mage::helper('evolved')->__('Navigation Menu Vertical Alignment:'),
      		'name'      => 'evolved_form_navigation[navigation_menu_vertical_alignment]',
      		'options'   => array(
   ...
   /***************** promo banner ********************************/
	 ...
	 $fieldsetpromo = $form->addFieldset('evolved_form_header_promo_banner', array('legend'=>Mage::helper('evolved')->__('Promo Banner')));
     $fieldsetpromo->addType('colorpicker', Mage::getConfig()->getBlockClassName('Ideal_Evolved_Block_Adminhtml_Evolved_Edit_Renderer_Color'));
     
     $fieldsetpromo->addField('header_promo_banner_onoff', 'select', array(
      		'label'     => Mage::helper('evolved')->__('Promo Banner'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_banner_onoff]',
      		'options'   => array(
      				'enable' => Mage::helper('evolved')->__('Enable'),
      				'disable' => Mage::helper('evolved')->__('Disable'),      				
      		), 
	  ...
	  $fieldsetpromo->addField('header_promo_banner_position', 'select', array(
      		'label'     => Mage::helper('evolved')->__('Promo Position'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_banner_position]',
      		'options'   => array(
      				'above' => Mage::helper('evolved')->__('Above'),
      				'below' => Mage::helper('evolved')->__('Below'),      				
      		), 
      ));
           
	  $fieldsetpromo->addField('header_promo_input_data', 'text', array(
      		'label'     => Mage::helper('evolved')->__('Promo Text'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_input_data]',
      ));
      $fieldsetpromo->addField('header_promo_height', 'text', array(
      		'label'     => Mage::helper('evolved')->__('Promo height'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_height]',
      ));
      
       $fieldsetpromo->addField('header_promo_bg_color', 'colorpicker', array(
      		'label'     => Mage::helper('evolved')->__('Background Color'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_bg_color]',
      ));
       $fieldsetpromo->addField('header_promo_text_color', 'colorpicker', array(
      		'label'     => Mage::helper('evolved')->__('Text Color'),
      		'name'      => 'evolved_form_header_promo_banner[header_promo_text_color]', 
      ));
