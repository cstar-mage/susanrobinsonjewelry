...
class Dolphin_Slideshow_Adminhtml_Slideshowadmin_IndexController extends Mage_Adminhtml_Controller_Action
{
	...
	public function editAction()
	{
		...
		if ($slideshowModel->getId() || $slideshowId == 0) {
			...
			($slideshowModel['desktop_img_check']) ? $slideshowModel['desktop_img_check']  : "";			
			($slideshowModel['landscape_ipad_img_check']) ? $slideshowModel['landscape_ipad_img_check']  : "";						
			($slideshowModel['portrait_ipad_img_check']) ? $slideshowModel['portrait_ipad_img_check']  : "";			
			($slideshowModel['mobile_img_check']) ? $slideshowModel['mobile_img_check']  : "";			
		...
		if ( $this->getRequest()->getPost() ) {
			...
			if(isset($_FILES['mobile_img']['name']) && $_FILES['mobile_img']['name'] != '') {
				...
				$slideshowModel->setId($this->getRequest()->getParam('id'))
					...
					->setDesktopImgCheck($postData['desktop_img_check'])
					->setDesktopImgTextarea($postData['desktop_img_textarea'])
					->setLandscapeIpadImgCheck($postData['landscape_ipad_img_check'])
					->setLandscapeIpadImgTextarea($postData['landscape_ipad_img_textarea'])
					->setPortraitIpadImgCheck($postData['portrait_ipad_img_check'])
					->setPortraitIpadImgTextarea($postData['portrait_ipad_img_textarea'])
					->setMobileImgCheck($postData['mobile_img_check'])
					->setMobileImgTextarea($postData['mobile_img_textarea'])
